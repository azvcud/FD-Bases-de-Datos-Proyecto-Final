...
public class MensajeroGestor {
     ...
     */
     ...
     public void registrarMensajero(long k_numeroDocumento,String k_tipodocumento, String n_primerNombre, String n_segundonombre,
      ...
      mensajero.setQ_seguridadSocial(q_seguridadsocial);
